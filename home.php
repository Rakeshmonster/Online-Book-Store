...
<body>
  ...
  <section class="about_cont">
    ...
    <div class="about_descript">
      ...
      <p>At Dahal Pustal Pasal, we are passionate about connecting readers with captivating stories, inspiring ideas, and a world of knowledge. Our Online book Ordering System is more than just a place to buy books; it's a haven for book enthusiasts, where the love for literature thrives.
    </p>
  ...
  <section class="questions_cont">
    ...
    <p>At Dahal Pustal Pasal, we value your satisfaction and strive to provide exceptional customer service. If you have any questions, concerns, or inquiries, our dedicated team is here to assist you every step of the way.</p>
